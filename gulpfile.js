...
gulp.task("fonts", function () {
  ...
  return gulp.src(["src/assets/fonts/**","src/assets/vendor/ionicons/fonts/**", "src/assets/vendor/font-awesome/fonts/**"])
...
gulp.task("js", function () {
  return gulp.src(["src/assets/javascript/main.js"])
...
gulp.task("images_copy", function () {
  return gulp.src(["src/assets/images"])
    .pipe(gulp.dest("site/assets/images"))
    .pipe($.size({ title: "compressed images" }));
});
...
gulp.task("publish", ["build"], function () {
  gulp.start("html", "copy", "css", "js", "images_copy", "fonts");
});
